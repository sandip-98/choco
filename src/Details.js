                        ...
                        <div className='row'>
                            <div className='col-xl-8 col-lg-8 col-md-8 col-sm-12'>
                                ...
                                <div className='paragraph'>
                                    <p>Hey, I'm Hanna, a master chocolatier with a passion for creating exquisite chocolate creations. With over 15 years of experience, I have established a reputation for crafting unique and memorable chocolate flavors that push the boundaries of traditional confectionery.</p>
